# This template files works if Cockpitdecks and Webdecks runs on the same computer
...
APP_HOST = ["127.0.0.1", 7777]  # That's where the web deck app run and can be contacted by the browser.
